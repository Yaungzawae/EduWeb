                    ...
                    <Table className="border-spacing-2">
                        ...
                        <TableHeader>
                            <TableRow>
                                ...
                                {/* <TableHead></TableHead>
                                <TableHead className="text-center">21</TableHead>
                                <TableHead className="text-center">22</TableHead>
                                <TableHead className="text-center">23</TableHead>
                                <TableHead className="text-center">24</TableHead>
                                <TableHead className="text-center">25</TableHead>
                                <TableHead className="text-center">26</TableHead>
                                <TableHead className="text-center">27</TableHead> */}
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {
                                        ...
                                        <Fragment>
                                            <TableRow>
                                                ...
                                                {Object.entries(x).map(([key, value], index) => (
                                                    <TimeTableCell type={value} day={key} time={index1} key={key+index} userId="1" changeTimeTable={changeTimeTable}/>
                            ...
                            {/* <TableRow>
                                <TableHead className="min-w-[100px]">8-10 AM</TableHead>
                                ...
                                <TableCell className="bg-black"></TableCell>
                                <TableCell className="bg-red-500"></TableCell>

                            </TableRow>
                            <TableRow>
                                <TableHead>10-12 PM</TableHead>

                            </TableRow>
                            <TableRow>
                                <TableHead>12-2 PM</TableHead>

                            </TableRow>
                            <TableRow>
                                <TableHead>2-4 PM</TableHead>

                            </TableRow>
                            <TableRow>
                                <TableHead>4-6 PM</TableHead>

                            </TableRow>
                            <TableRow>
                                <TableHead>6-8 PM</TableHead>
